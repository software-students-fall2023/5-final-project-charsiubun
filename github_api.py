...
def get_feedback(username, score):
    high_score_roasts = [
        ...
        f"{username} you,'ve got more commits than a book has words!",
        f"Is {username}'s home address localhost?",
        f"{username}, you're the human embodiment of 'It works on my machine.'",
        f"{username}'s keyboard must be applying for a restraining order any day now.",
        f"I bet {username} dreams in code, don’t you {username}?",
        ...
        f"{username} doesn't get bugs; {username} gets 'unexpected features', right?",
        ...
        f"{username} might be the only person who reads the entire terms and conditions before accepting."
    ]
    ...
    medium_score_roasts = [
        ...
        f"{username}, you're the 'I’ll fix this bug later' kind of person, aren't you {username}?",
        ...
        f"{username}, you’re not a coder; {username}, you’re a ‘coding enthusiast’.",
    ...
    low_score_compliments = [
        ...
        f"{username}, you're probably the person who actually goes outside and enjoys the sun.",
        ...
        f"{username}, you're too busy making real-life memories!",
        ...
        f"{username}, you’re living proof there’s a world beyond the keyboard.",
        ...
        f"{username}, you're the kind of person who makes tech-free zones cool.",
        ...
        f"{username}, you're like a rare gem in today's digital-dominated world.",
        ...
        f"{username}, you’re the person everyone wants at a dinner party – no tech talk!",
        f"{username}'s presence is probably more real-world than virtual – how refreshing!",
        f"{username}, you’re too busy being a main character in real life.",
